...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='inference/edge_pic', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--output', type=str, default='inference/edge_out-m-100', help='output folder')  # output folder
    parser.add_argument('--img-size', type=int, default=1224, help='inference size (pixels)')
